(ns foundrymfg.operation-test
  "Smoke tests for the compiled FoundryOperationActor graph itself
  (build + one happy path per op). The governor's full rule contract
  (HARD holds, escalation, phase gating) is exercised in
  `foundrymfg.governor-contract-test`; the Store contract in
  `foundrymfg.store-contract-test`."
...
(deftest test-actor-builds
  (testing "FoundryOperationActor can be built with a store"
