# Business Model: Casting of iron and steel
...
## Classification
- Repository: `cloud-itonami-isic-2431` ([github.com/cloud-itonami/cloud-itonami-isic-2431](https://github.com/cloud-itonami/cloud-itonami-isic-2431))
- ISIC Rev.5: `2431` — Casting of iron and steel
- Domain: `:iron-steel-casting/manufacturing`
- Social impact: :worker-safety :materials-safety :resource-efficiency
- Actor: `:foundry-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :iron-steel-casting/manufacturing — who wants
...
One managed tenant (:iron-steel-casting/manufacturing):
...
- Do not bypass the `:foundry-plant-operations-governor` for production decisions.
