# Operator Quickstart — Casting of iron and steel

Shortest path from clone to a verified local dry-run for **ISIC 2431** (`cloud-itonami-isic-2431`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2431.git
cd cloud-itonami-isic-2431
```
...
- Blueprint governor key: `foundry-plant-operations-governor`
- Likely source path: `foundrymfg.governor.cljc`
