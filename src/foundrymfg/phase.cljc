(ns foundrymfg.phase
  "Phase 0->3 staged rollout for the iron-and-steel casting foundry
  ...
  consequence (a melting-furnace/mold/shakeout-equipment maintenance
  window means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `foundrymfg.governor`'s `furnace-actuate-blocked-violations` HARD-blocks
...
(defn verdict->disposition
  "Map a Foundry Plant Operations Governor verdict to a base
